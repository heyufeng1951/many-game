(()=>{
    ...
    var e, t = {
        ...
        82870: (e,t,s)=>{
            ...
            const f = {
              ...
              , v = {
                ...
                settingsHamburgerMenu_closeButton: {
                    ...
                    margin: "6px",
                    [(0,
                    b.Ih)("right", "left", l.fn.direction)]: "0",
            ...
            class J {
                constructor() {
                    ...
                    J.offline = this,
                    this.loadData(),
                    he.subscribe(this.loadData.bind(this))
                }
                loadData() {
                    const e = he.getState();
                    this.localData = {
                ...
                saveData(e) {
                    he.dispatch(ne(e)),
                    ce.saveZigZagHighScore(e.zigzag_bestScore),
                    ce.saveEndlessHighScore(e.endless_bestScore),
                    ce.saveTimeTrialHighScore(e.timetrial_bestScore),
                    ce.saveGameMode(e.mode),
                    ce.saveHighVisibilityMode(e.highVisibilityMode),
                    ce.saveReducedSpeedMode(e.gameSpeed < ie),
                    ce.saveDefaultCharacter(e.currentCharacter),
                    ce.saveDefaultTheme(e.theme)
                }
                resetData() {
                    he.dispatch(re()),
                    ce.resetAllStats()
                ...
                storeEndlessStats() {
                    ...
                    !s.cheat.used && e > t && (se.sys.session.bestScore.endless = e,
                    s.highScore = !0,
                    this.saveData({
                        ...he.getState(),
                        endless_bestScore: e
                ...
                storeTimeTrialStats() {
                    ...
                    !s.cheat.used && (e < t || t < 0) && s.finish && (se.sys.session.bestScore.timetrial = e,
                    s.highScore = !0,
                    this.saveData({
                        ...he.getState(),
                ...
                storeZigZagStreak() {
                    const e = se.sys.getCurrentScore()
                      ...
                      , s = se.sys.game;
                    ce.recordGameEnd(this.getCommonStats(G.ZigZag, e)),
                    !s.cheat.used && e > t && (se.sys.session.bestScore.zigzag = e,
                    s.highScore = !0,
                    this.saveData({
                        ...he.getState(),
                        zigzag_bestScore: e
            ...
            class se {
                constructor() {
                    ...
                    this.resetGameData(),
                    he.subscribe(this.loadSessionSettings.bind(this))
                }
            ...
            const ie = 1
              , ae = {
                ...
                highVisibilityMode: c.p.getBoolean("highVisibilityActive"),
                gameSpeed: c.p.getBoolean("reducedSpeedActive") ? .5 : ie,
                mode: j(c.p.getString("lastSelectedMode")),
                theme: W(c.p.getString("lastSelectedTheme")),
                gameState: ee.Menu,
            ...
            function le(e) {
                return parseInt(c.p.getValue(e))
            }
            !function(e) {
            ...
            class ce {
                ...
                static resetAllStats() {
                    c.e.send("reset-stats")
                }
                static saveEndlessHighScore(e) {
                    c.e.send("set-high-score", [G.Endless, Math.floor(e)])
                }
                static saveZigZagHighScore(e) {
                    c.e.send("set-high-score", [G.ZigZag, Math.floor(e)])
                }
                static saveTimeTrialHighScore(e) {
                    let t = e;
                    e > 0 && (t *= 1e3),
                    c.e.send("set-high-score", [G.TimeTrial, Math.floor(t)])
                }
                static saveGameMode(e) {
                    c.e.send("save-game-mode", [e])
                }
                static saveHighVisibilityMode(e) {
                    c.e.send("save-high-visibility-mode", [e])
                }
                static saveReducedSpeedMode(e) {
                    c.e.send("save-reduced-speed-mode", [e])
                }
                static saveDefaultCharacter(e) {
                    c.e.send("save-selected-character", [e])
                }
                static saveDefaultTheme(e) {
                    c.e.send("save-selected-theme", [e])
                }
                static recordUnload() {
                    ...
                    c.e.send("record-unload", [t, e]),
                    ce.numZigZagGames = 0,
                    ce.numEndlessGames = 0,
                    ce.numTimeTrialGames = 0,
                    ce.sessionStartTime = Date.now()
                }
                static recordGameEnd(e) {
                    ...
                    c.e.send("record-game-end", [t])
                }
                static recordSharePopup() {
                    c.e.send("record-share-popup")
                }
                static recordShareClick() {
                    c.e.send("record-share-click")
                }
                static startShare(e, t, s, i) {
                    c.e.send("start-share", [e, t, s, i])
                }
                static async getPercentage(e, t) {
                    return (await (0,
                    K.yt)("get-percentage", [e, t])).percentage
                }
            }
            ce.numTimeTrialGames = 0,
            ce.numEndlessGames = 0,
            ...
            class pe {
                ...
                createBackground() {
                    this.canvas = ve.sys.createNewCanvas(),
                    this.ctx = this.canvas.getContext("2d"),
                    this.gradient = ve.sys.createNew("div", document.body, "game-gradient"),
                    this.bg = ve.sys.createNew("div", document.body, "game-bg"),
                    this.offset = {
                        x: 0,
                        y: 0
                    }
                ...
                defineCanvas() {
                    ...
                    se.sys.session.w = parseInt(e.getPropertyValue("width"), 10),
                    se.sys.session.h = parseInt(e.getPropertyValue("height"), 10),
                    this.canvas.style.width = se.sys.session.w + "px",
                    this.canvas.style.height = se.sys.session.h + "px",
                    this.canvas.width = se.sys.session.w,
                    this.canvas.height = se.sys.session.h,
                    se.sys.session.x = Math.floor(.5 * se.sys.session.w),
                    se.sys.session.y = Math.floor(.4 * se.sys.session.h),
                ...
                drawLayer(e, t, s=0, i=0, a=0, o="looping", n) {
                    ...
                    if (this.draw(be.sys.objectsImg, r, s, i, l[h]),
                ...
                drawBoost(e) {
                    const t = pe.sys.ctx;
                    t.strokeStyle = "rgba(" + be.sys.accent + ",0.5)",
                    t.lineCap = "round",
                    t.setLineDash([]),
                    e.forEach((e=>{
                        const s = .5 - e.time;
                ...
                drawShield(e, t) {
                    const s = se.sys.game.shields.current / se.sys.game.shields.max / 2 + .5
                      ...
                      , r = pe.sys.ctx;
                    r.beginPath(),
                    r.ellipse(e, t, o, .7 * o, 0, 0, 2 * Math.PI),
                    r.strokeStyle = "rgba(" + be.sys.accent + "," + (6 - i) / 4 + ")",
                    r.lineWidth = 6 - i,
                    r.stroke(),
                    r.beginPath(),
                    r.ellipse(e, t, n / 2, n / 2 * .7, 0, 0, 2 * Math.PI),
                    r.fillStyle = "rgba(" + be.sys.accent + "," + a / 8 + ")",
                    r.fill()
                }
                drawPickup(e) {
                    if (e.time >= 1)
                    ...
                    a.strokeStyle = "rgba(" + be.sys.accent + "," + (1 - t) + ")",
                    a.lineWidth = 6 * (1 - t),
                    a.stroke(),
                    a.beginPath(),
                    a.arc(e.x, e.y, i, 0, 2 * Math.PI),
                    a.strokeStyle = "rgba(" + be.sys.accent + "," + (1 - 2 * t) + ")",
                    a.lineWidth = 6 * (1 - 2 * t),
                    a.stroke()
                }
                drawHitbox(e, t) {
                    ...
                    if (se.sys.session.forcedColors)
                        switch (s) {
                        case "crash":
                            a = "CanvasText";
                            break;
                ...
                drawBoundaries() {
                    const e = se.sys.session.x - se.sys.game.dist.x
                      ...
                      , s = pe.sys.ctx;
                    s.beginPath(),
                    s.rect(0, 0, e - t, se.sys.session.h),
                    s.rect(e + t, 0, se.sys.session.w, se.sys.session.h),
                    s.fillStyle = "rgba(" + be.sys.boundary + ")",
                    s.fill()
                }
            ...
            class be {
                ...
                setNewTheme(e) {
                    ...
                    pe.sys.bg.style.backgroundImage = "url(" + this.bgImg.src + ")",
                    pe.sys.bg.style.backgroundSize = this.bgSize + "px " + this.bgSize + "px";
                    const s = this.gradient.start.join(", ")
                      , i = this.gradient.end.join(", ");
                    pe.sys.gradient.style.background = "linear-gradient(180deg, rgb(" + s + ") 0%, rgb(" + i + ") 100%)",
                    se.sys.session.settings.theme = e,
                    ge.sys.createPlayerSprite(),
                    se.sys.saveSessionSettings(),
            ...
            class ge {
                constructor() {
                    ...
                    !1 === c.p.getBoolean("isLinuxTuxEnabled") && this.characterList.forEach(((e,t)=>{
                        "linux" === e && this.characterList.splice(t, 1)
                    }
                    )),
                    !0 === c.p.getBoolean("isLinuxTuxEnabled") && (this.selectionList = ["linux", "player1", "player2", "player3", "player4", "player5", "player6", "player7"])
                }
                createPlayerSprite() {
                    const e = 640
                    ...
                    s.drawImage(be.sys.playerImg, 0, 0, e, 192, 0, 0, e, 192);
                    ...
                    if (this.applyLayers(s, be.sys.playerImg, o, e, 64),
                    se.sys.game.friend) {
            ...
            ge.sys = null;
            const ue = e=>i.createElement("svg", {
                width: "20",
                height: "20",
                viewBox: "0 0 20 20",
              ...
              , ye = ()=>{
                ce.startShare(c.p.getString("shareString"), "", "", c.p.getString("shareNewLinkMobile")),
                ce.recordShareClick()
            }
              , fe = (0,
            p.ZP)({
            ...
            }, c.p.getString("shareButtonString"))))))
              , we = (0,
            p.ZP)({
                shareBestScore: {
                    display: "flex",
                ...
                const t = c.p.getStringF("bestScoreFlyout", e.bestScoreFormatted);
            ...
            class ve {
                constructor() {
                    ...
                    this.buildInterface(),
                    this.notifyTimer = void 0,
                    he.subscribe(this.updateScore.bind(this))
                }
                buildInterface() {
                ...
                updateGameTitleUI() {
                    ...
                    this.title.textContent = c.p.getString(e + "Theme")
                }
                updateGameModeUI() {
                    const e = se.sys.session.settings.mode;
                    this.subtitle.style.removeProperty("visibility"),
                    this.subtitle.textContent = c.p.getString(e + "Title"),
                    this.updateScore()
                }
                updateInputTypeUI() {
                    ...
                    switch (t === te.Mouse && Q() && (t = te.Touch),
                    t) {
                    case te.Mouse:
                    case te.Touch:
                    case te.Keyboard:
                        this.instructAction.classList.add("outline"),
                        this.instructAction.textContent = c.p.getString(t + "Action");
                        break;
                    case te.Ps:
                    case te.Xbox:
                        {
                    ...
                    this.instructText.textContent = c.p.getString(e + "Info"),
                    this.instructContent.style.removeProperty("visibility"),
                    e !== ee.Menu ? this.instructContent.classList.add("tinted") : this.instructContent.classList.remove("tinted")
                }
                tintScreen() {
                ...
                sendNotification(e, t=5e3) {
                    const s = se.sys.session.settings.mode
                      ...
                      , a = c.p.getBoolean("isNewShare");
                    switch (this.notifyContent.textContent = "",
                    e) {
                    case "mode":
                        this.notifyContent.textContent = c.p.getStringF("gameMode", c.p.getString(s + "Title"));
                        break;
                    case "theme":
                        this.notifyContent.textContent = c.p.getStringF("theme", c.p.getString(i + "Theme"));
                        break;
                    case "score":
                        {
                            const e = se.sys.getHighScore(s);
                            this.notifyContent.textContent = c.p.getStringF("newBestScore", c.p.getString(s + "Descriptor"), e, c.p.getString(s + "Unit")),
                            this.createIconSVG(this.notifyContent, "star", 20, 20, "0 4px 0 0");
                            break
                        }
                    case "cheatcode":
                        this.notifyContent.textContent = c.p.getStringF("codeCheat", c.p.getString("codeScoring"));
                        break;
                    case "code":
                        this.notifyContent.textContent = c.p.getString("code");
                        break;
                    case "cheat":
                        this.notifyContent.textContent = c.p.getString("codeScoring");
                        break;
                    case "share":
                        if (a)
                            return void this.updateAndShowNewShare();
                        this.notifyContent.textContent = c.p.getString("share"),
                ...
                createShareLink() {
                    ...
                    this.createNew("p", e, "notify-shareText").textContent = c.p.getString("shareCopy"),
                    this.createIconSVG(e, "link", 20, 20, "0 4px 0 0")
                }
                copyShareLink() {
                    Y(c.p.getString("shareLinkGameOver")),
                    this.notifyContent.textContent = c.p.getString("shareLinkCopied")
                }
                showNotification() {
                ...
                async updateShare() {
                    const e = se.sys.session.settings.mode
                      ...
                      , o = s + " " + c.p.getString(e + "Unit")
                      , n = await ce.getPercentage(e, parseInt(s));
                    a.render(i.createElement(He, {
                ...
                getHighScoreString() {
                    return c.p.getStringF("bestScoreMenuDisplay", se.sys.getHighScore(se.sys.session.settings.mode), c.p.getString(se.sys.session.settings.mode + "Unit"))
                }
                checkHighScoreIcon() {
                    const e = se.sys.session.state;
                    this.scoreIcon.textContent = "",
                    (e === ee.Menu || se.sys.game.highScore) && this.createIconSVG(this.scoreIcon, "star", 20, 20)
                }
                updateScore() {
                    const e = se.sys.session.settings.mode;
                    if (se.sys.session.state === ee.Menu) {
                        const t = se.sys.getHighScore(e);
                        this.scoreText.textContent = c.p.getStringF("bestScoreMenuDisplay", t, c.p.getString(e + "Unit"))
                    } else {
                        const t = se.sys.getCurrentScoreFormatted();
                        this.scoreText.textContent = t + " " + c.p.getString(e + "Unit")
                    }
                }
                updateIcons() {
                    const e = []
                    ...
                    if (s.lives || s.safety)
                        ...
                        for (let t = 1; t <= se.sys.game.lives.max; t++) {
                            let s = "life-empty";
                            t <= se.sys.game.shields.current ? s = "shield" : t <= se.sys.game.lives.current && (s = "life-full"),
                            e.push(s)
                        }
                    if (s.boosts)
                        t.push("boost-full"),
                ...
                createIconSVG(e, t, s, i, a="0 0 0 0") {
                    ...
                    n.classList.add("icon-fill"),
                    n.setAttribute("d", this.icons[t].path),
                    e.insertAdjacentElement("afterbegin", o),
                    o.insertAdjacentElement("afterbegin", n)
                }
                defineIcons() {
                    this.icons = {
                        share: {
                ...
                createNew(e, t, s, i) {
                    ...
                    return void 0 !== t && t.insertAdjacentElement("beforeend", a),
                    void 0 !== s && (a.id = s),
            ...
            class xe extends Ve {
                ...
                draw() {
                    this.pickup ? pe.sys.drawPickup(this) : (void 0 !== this.fx && "hidden" !== this.anim && pe.sys.drawFx(this.time, this.x, this.y + this.fx),
                    pe.sys.drawLayer(this.type, this.pose, this.x, this.y, this.time, this.anim, this),
                    void 0 !== this.decor && pe.sys.drawLayer("wallDecor", this.decor, this.x, this.y - 24))
                }
            }
            class Me extends xe {
                constructor(e, t, s, i) {
                ...
                isCrashed() {
                    return !(this.timer.crash <= 0) && (this.timer.crash -= se.sys.game.time.loop * se.sys.game.time.scale,
                ...
                updateDirection() {
                    if (this.timer.dir -= se.sys.game.time.loop * se.sys.game.time.scale,
                    this.timer.dir <= 0) {
                ...
                updateSpeed() {
                    ...
                    this.speed.current = e.raw * se.sys.game.time.scale
                }
                updatePosition() {
            ...
            class Se extends xe {
                ...
                updateDirection() {
                    if (this.dist = Math.hypot(se.sys.session.x - this.x, se.sys.session.y - this.y),
                    this.timer.dir -= se.sys.game.time.loop * se.sys.game.time.scale,
                    this.timer.dir <= 0) {
            ...
            class Ce {
                constructor() {
                    ...
                    Ce.sys)
                        return Ce.sys;
                    Ce.sys = this,
                    window.addEventListener("keydown", (e=>Ce.sys.onKeydown(e)), !1),
                    window.addEventListener("keyup", (e=>Ce.sys.onKeyup(e)), !1),
                    this.pressed = {}
                }
                onKeydown(e) {
                    const t = e.key.toLowerCase();
                    if (Ee.sys.changeInputMethod(te.Keyboard),
                    !this.pressed[t]) {
                        switch (this.pressed[t] = !0,
                        t) {
                        case "arrowdown":
                        case "s":
                            Ee.sys.routeInput(Te.Down);
                            break;
                        case "arrowleft":
                        case "a":
                            Ee.sys.routeInput(Te.Left);
                            break;
                        case "arrowright":
                        case "d":
                            Ee.sys.routeInput(Te.Right);
                            break;
                        case "arrowup":
                        case "w":
                            Ee.sys.routeInput(Te.Stop);
                            break;
                        case "enter":
                        case " ":
                            Ee.sys.routeInput(Te.Toggle);
                            break;
                        case "escape":
                            Ee.sys.routeInput(Te.Settings, !1, !1);
                            break;
                        case "f":
                            Ee.sys.routeInput(Te.Boost, !1, !1)
                        }
                        Ee.sys.checkCheatCode(t)
                    }
                }
                onKeyup(e) {
                    const t = e.key.toLowerCase();
            ...
            class ke {
                ...
                onClick(e) {
                    if (se.sys.session.flyoutActive)
                        return;
                    Ee.sys.changeInputMethod(te.Mouse);
                    const t = ve.sys.selector || null;
                    t && t.contains(e.target) || Ee.sys.routeInput(Te.Toggle)
                }
                onMouseMove(e) {
                    if (se.sys.session.state === ee.Play) {
                        const t = this.checkAngle(se.sys.session, e);
                        this.mousePos !== t && (this.mousePos = t,
                        Ee.sys.routeInput(t, !0, !1))
                    }
                }
                onContextMenu(e) {
                    e.preventDefault(),
                    se.sys.session.state === ee.Play && Ee.sys.routeInput(Te.Boost, !1, !1)
                }
                checkAngle(e, t) {
            ...
            class Ze {
                constructor() {
                    ...
                    Ze.sys)
                        return Ze.sys;
                    Ze.sys = this,
                    window.addEventListener("touchstart", (e=>Ze.sys.onTouchStart(e)), !1),
                    window.addEventListener("touchmove", (e=>Ze.sys.onTouchMove(e)), !1),
                    window.addEventListener("touchend", (e=>Ze.sys.onTouchEnd(e)), !1),
                    this.reset()
                }
                reset() {
                    this.swipeStart = 0,
                ...
                onTouchStart(e) {
                    if (!this.interact(e) && (Ee.sys.changeInputMethod(te.Touch),
                    e.targetTouches)) {
                ...
                onTouchEnd(e) {
                    ...
                    Math.abs(t) < 10 && Math.abs(s) < 10) {
                        ...
                        se.sys.session.state === ee.Menu ? t === Te.Left || t === Te.Right ? Ee.sys.routeInput(t, !0, !1) : Ee.sys.routeInput(Te.Toggle) : Ee.sys.routeInput(t, !0, !0),
                        Ee.sys.checkCheatCode(t)
                ...
                interact(e) {
                    const t = e.target;
                    return !(!se.sys.session.flyoutActive && !t.closest("button")) || (e.cancelable && e.preventDefault(),
                    !1)
                }
            }
            let Te;
            ...
            class Ee {
                ...
                routeInput(e, t=!1, s=!0) {
                    if (se.sys.session.flyoutActive)
                        return void (e === Te.Settings && this.inputSettings());
                    const i = se.sys.session.inputType;
                    let a = !1;
                    if (s && (a = this.registerDoubleInput(e)),
                    i !== te.Mouse && i !== te.Touch || e !== Te.Toggle || a)
                        if (i !== te.Keyboard && i !== te.Touch || e !== Te.Down || t || !a ? i === te.Touch && a && (e = Te.Toggle) : e = Te.Boost,
                        se.sys.session.state !== ee.Menu || e !== Te.Left && e !== Te.Right)
                            switch (e) {
                            case Te.Toggle:
                                this.inputToggle();
                                break;
                ...
                changeInputMethod(e) {
                    se.sys.session.inputType === e || this.lastInputTime + 100 > Date.now() || (this.lastInputTime = Date.now(),
                    se.sys.session.inputType = e,
                    ve.sys.updateInputTypeUI())
                }
                inputToggle() {
                    const e = se.sys.session.state;
                ...
                inputSettings() {
                    se.sys.session.state === ee.Play && _e.sys.changeGameState(ee.Pause),
                ...
                cheat(e, t=!0) {
                    ...
                    if (t && se.sys.session.state === ee.Menu)
                        switch (s.used = !0,
                        s[e] = !0,
                        e) {
                        case "lives":
            ...
            class Pe {
                constructor() {
                    ...
                    Pe.sys)
                        return Pe.sys;
                    Pe.sys = this,
                    window.addEventListener("gamepadconnected", (e=>Pe.sys.onGamepadConnected(e))),
                    window.addEventListener("gamepaddisconnected", (e=>Pe.sys.onGamepadDisconnected(e))),
                    this.indexList = [],
                ...
                onGamepadConnected(e) {
                    Pe.sys.indexList.push(e.gamepad.index)
                }
                onGamepadDisconnected(e) {
                    const t = Pe.sys.indexList.indexOf(e.gamepad.index);
                    t > -1 && Pe.sys.indexList.splice(t, 1),
                    this.linkedPad = {
                        index: void 0,
                        pad: void 0,
                        pressed: {}
                    ...
                    s !== te.Xbox && s !== te.Ps || Ee.sys.changeInputMethod(te.Keyboard)
                }
                setController(e, t) {
                    this.linkedPad = {
                        index: e,
                ...
                checkJoysticks(e) {
                    ...
                    let n;
                    if (s || i || o || a ? (this.changeControllerType(e),
                    !o || s || i ? !a || s || i ? !i || o || a ? !s || o || a ? s && o ? n = Te.Right : s && a ? n = Te.DownRight : i && o ? n = Te.Left : i && a && (n = Te.DownLeft) : n = Te.Right : n = Te.Left : n = Te.Down : n = Te.Stop) : this.last = void 0,
                    this.last === n)
                        return null;
                    if (this.last = n,
                    n)
                ...
                checkButtons(e) {
                    ...
                    if (t(e.buttons[4]) && t(e.buttons[5]))
                        return Ee.sys.routeInput(Te.Reset),
                    ...
                    for (let a = 0; a < i; a++)
                        if (t(e.buttons[a])) {
                            if (this.linkedPad.pressed[this.buttonMap[a]])
                                return null;
                            if (this.linkedPad.pressed[this.buttonMap[a]] = !0,
                            this.changeControllerType(e),
                            se.sys.session.flyoutActive && ["a", "b", "up", "down"].includes(this.buttonMap[a])) {
                            ...
                            Ee.sys.routeInput(s, !1, !1),
                            Ee.sys.checkCheatCode(s)
                        } else
                            this.linkedPad.pressed[this.buttonMap[a]] = !1;
                    return s
                }
            ...
            class Ie extends xe {
                ...
                checkBoundaries() {
                    ...
                    case G.ZigZag:
                        ...
                        break;
                    case G.Endless:
                        e.y < 8e3 && e.x < -6400 && !Le.sys.swapBuilt && Le.sys.buildSwap(),
                        !se.sys.game.highScore && e.unit > se.sys.session.bestScore.endless && !se.sys.game.cheat.used && (se.sys.game.highScore = !0,
                        ve.sys.refreshDisplay(),
                        e.unit > 100 && ve.sys.sendNotification("score"))
                    }
                }
                changeCharacter(e, t=!1) {
                    const s = ge.sys.characterList[se.sys.session.settings.character];
                    let i, a;
                    t && (i = ge.sys.characterList[e],
                    ge.sys.selectionList.includes(i) || ge.sys.selectionList.push(i),
                    a = ge.sys.selectionList.indexOf(i));
                    const o = ge.sys.selectionList;
                    t || (a = (o.length + ge.sys.selectionList.indexOf(s) + e) % o.length,
                    i = ge.sys.selectionList[a]),
                    this.skins.render = [];
                    ...
                    se.sys.session.settings.character = ge.sys.characterList.indexOf(i),
                    se.sys.saveSessionSettings(),
                    ge.sys.createPlayerSprite(),
                    Pe.sys.setVibration("small")
                }
                routeAction(e, t=!1) {
                    if (!(se.sys.session.state !== ee.Play || this.timer.crash || "bounce"in this.dist || "air"in this.dist && e !== Te.Down))
                        switch (e) {
                        case Te.Stop:
                            this.stop();
                            break;
                ...
                updateTrackers() {
                    this.timer.crash && (this.timer.crash -= se.sys.game.time.loop * se.sys.game.time.scale,
                ...
                updateSpeed() {
                    ...
                    this.speed.current = t.raw * se.sys.game.time.scale
                }
                stop() {
                    this.changeDirection("stop"),
                    this.stopPlayerSpeed(),
                    Pe.sys.setVibration("tiny")
                }
                down() {
                    "air"in this.dist ? (this.trick = this.trick % 2 + 1,
                    1 === this.trick ? this.changePose("air1") : this.changePose("air2"),
                    Pe.sys.setVibration("small")) : this.changeDirection("down")
                }
                slow() {
                    this.speed.raw *= .7,
                    Pe.sys.setVibration("slow")
                }
                crash() {
                    if ("immune"in this.dist)
                        return;
                    const e = se.sys.game.cheat;
                    se.sys.game.friend && !e.safety && (this.removeFriend(),
                    Le.sys.buildCrashedFriend(this.x + 48 * (Math.random() - .5), this.y + 32)),
                    e.lives || e.safety || (se.sys.game.lives.current -= 1),
                    ve.sys.refreshDisplay(),
                    se.sys.game.lives.current <= 0 ? this.lose() : (this.timer.crash = 1,
                    this.stopPlayerSpeed(),
                    this.dist.immune = 96,
                    this.changePose("crash"),
                    Pe.sys.setVibration("crash"))
                }
                air(e) {
                    this.timer.crash || (this.changeDirection("down"),
                    "boost"in this.dist && (this.dist.boost += e),
                    this.dist.air = e,
                    this.trick = se.sys.rand(1, 2),
                    this.speed.max = this.speed.base + this.speed.airAdd,
                    this.shadow = 0,
                    this.down(),
                    Pe.sys.setVibration("ramp"))
                }
                boost(e=!1) {
                    !e && (se.sys.game.boosts.current <= 0 || "boost"in this.dist) || (e || se.sys.game.cheat.boosts || (se.sys.game.boosts.current -= 1),
                    this.dist.boost = 2e3,
                    this.speed.max = this.speed.base + this.speed.boostAdd,
                    ve.sys.refreshDisplay(),
                    Pe.sys.setVibration("boost"))
                }
                bounce() {
                    this.spin(),
                    this.dist.bounce = 32
                ...
                swap() {
                    ...
                    this.hitbox.w += 64,
                    this.hitbox.h += 64,
                    Le.sys.top.filter((e=>"lure" === e.type)).forEach((e=>{
                        Le.sys.buildObject("foe", e.x, e.y, "chase"),
                        e.sleep = !0
                    }
                    )),
                    se.sys.game.cheat.used = !0,
                    ve.sys.sendNotification("cheat"),
                    Pe.sys.setVibration("big")
                }
                spin() {
                ...
                collectBoost() {
                    se.sys.game.boosts.current < se.sys.game.boosts.max && (se.sys.game.boosts.current += 1,
                    ve.sys.refreshDisplay()),
                    Pe.sys.setVibration("pickup")
                }
                collectLife() {
                    se.sys.game.lives.current < se.sys.game.lives.max && (se.sys.game.lives.current += 1,
                    ve.sys.refreshDisplay()),
                    Pe.sys.setVibration("pickup")
                }
                collectCoin() {
                ...
                collectFriend() {
                    se.sys.game.friend = !0,
                    ge.sys.createPlayerSprite(),
                    se.sys.session.settings.mode === G.Endless && (se.sys.game.shields.current = se.sys.game.shields.max,
                    ve.sys.refreshDisplay()),
                    Pe.sys.setVibration("pickup")
                }
                removeFriend(e=!1) {
                    !se.sys.game.friend || se.sys.game.cheat.safety || e || (se.sys.game.friend = !1,
                    ge.sys.createPlayerSprite(),
                    se.sys.game.shields.current = 0,
                    ve.sys.refreshDisplay())
                }
                useShield() {
                    se.sys.game.cheat.safety || (se.sys.game.shields.current -= 1,
                    ve.sys.refreshDisplay(),
                    Pe.sys.setVibration("small"))
                }
                lose() {
                    se.sys.game.lives.current = 0,
                    se.sys.game.shields.current = 0,
                    this.dist.immune = 0,
                    this.stopPlayerSpeed(),
                    this.changePose("crash"),
                    this.boostFx = [],
                    _e.sys.changeGameState(ee.Over),
                    Pe.sys.setVibration("big")
                }
                finishline() {
                    se.sys.game.finish = !0,
                    this.stopPlayerSpeed(),
                ...
                passGate(e) {
                    e - 1 === this.previousGate && (se.sys.game.gates += 1),
                    this.previousGate = e,
                    se.sys.saveGameStats(),
                    ve.sys.refreshDisplay(),
                    Pe.sys.setVibration("small")
                }
                failGate(e) {
                    se.sys.game.highScore && (ve.sys.sendNotification("score"),
                    se.sys.game.highScore = !1),
                    se.sys.game.gates = 0,
                    this.previousGate = e,
                    ve.sys.refreshDisplay(),
                    Pe.sys.setVibration("slow")
                ...
                renderCharacterSelection() {
                    ...
                    for (let o = 0; o < t; o++) {
                        ...
                        if (o !== s)
                            l = "down",
                            pe.sys.drawPlayerMenu(h, l, se.sys.session.x + t * (o - s), se.sys.session.y, n + r);
                        else {
                            n = this.scale;
                            se.sys.game.shields.current / se.sys.game.shields.max > 0 && pe.sys.drawShield(this.x, this.y + 16),
                            pe.sys.drawPlayerSprite(l, e, se.sys.session.x + t * (o - s), se.sys.session.y, n + r)
                        }
                    }
                    a.restore()
                }
                draw() {
                    if (this.boostFx.length > 0 && pe.sys.drawBoost(this.boostFx),
                    this.swapped)
                        pe.sys.drawLayer("foe", this.pose, this.x, this.y, this.time, this.anim);
                    else {
                        const e = se.sys.game.time.elapsed;
                        se.sys.game.shields.current / se.sys.game.shields.max > 0 && pe.sys.drawShield(this.x, this.y + 16),
                        "air"in this.dist && (this.dist.air < 256 ? this.shadow = this.dist.air / 4 : this.shadow < 64 ? this.shadow += 3 * se.sys.game.time.scale : this.shadow = 64,
                        pe.sys.drawShadow(this.x, this.y + 16, this.shadow)),
                        "immune"in this.dist && (pe.sys.ctx.save(),
                        pe.sys.ctx.globalAlpha = Math.floor(4 * e) % 2 == 0 ? .4 : .7),
                        pe.sys.drawPlayerSprite(this.pose, e, this.x, this.y, this.scale),
                        "immune"in this.dist && pe.sys.ctx.restore()
                    }
                }
            }
            Ie.sys = null;
            class Le {
                constructor() {
                    ...
                    Le.sys = this,
                    new de,
                    new Ie("player",se.sys.session.x,se.sys.session.y,"down"),
                    this.reset(),
                ...
                nextReady(e, t=!0) {
                    let s;
                    return s = t ? se.sys.game.dist.unit : se.sys.game.dist.y + (se.sys.session.h - se.sys.session.y),
                ...
                createEndlessRow() {
                    ...
                    for (; a <= i; a++) {
                        ...
                        if (0 === a)
                            ...
                            "air"in e.dist)
                                ...
                                if (this.nextReady(t.checkpoint))
                                    return void this.buildCheckpoint(se.sys.session.x, s);
                            ...
                            i = se.sys.rand(-20, 20) * this.grid.size,
                            o = se.sys.rand(0, 32) * this.grid.size;
                        let r = 0;
                        ...
                        const l = se.sys.session.x + a * this.grid.gap + i + r
                          , h = s + o;
                        this.buildCluster(n, l, h),
                        this.buildEndlessRandomSnags(l, h)
                    }
                }
                ...
                createZigZagStart() {
                    this.buildCluster("zigzagGates", se.sys.session.x, se.sys.session.y + 512, "gateFirst"),
                ...
                createGateClusters(e, t, s) {
                    ...
                    if (this.buildCluster("zigzagGateScenes", e, a),
                    ...
                    this.buildCluster("allNormal", e - 560, o + se.sys.rand(0, 32) * this.grid.size, se.sys.randIndex(this.zigzag.clusterList)),
                    this.buildCluster("allNormal", e + 560, o + se.sys.rand(0, 32) * this.grid.size, se.sys.randIndex(this.zigzag.clusterList))
                }
                confirmGate(e) {
                ...
                buildCrashedFriend(e, t) {
                    ...
                    this.endless.friend.next = se.sys.game.dist.unit + this.endless.friend.inc
                }
                buildCheckpoint(e, t) {
                    this.endless.row.next += this.endless.row.inc,
                    this.top = this.sleep(this.top, -64, se.sys.session.h + 64),
                ...
                buildSwap() {
                    ...
                    this.top = this.sleep(this.top, -64, se.sys.session.h + 64),
                    this.buildCluster("endlessSwap", se.sys.session.x - (se.sys.session.h - se.sys.session.y) - 256, se.sys.session.h + 256)
                }
                buildObject(e, t, s, i) {
                    t = Math.floor(t) + (se.sys.game.dist.x - Math.floor(se.sys.game.dist.x)),
                    s = Math.floor(s) + (se.sys.game.dist.y - Math.floor(se.sys.game.dist.y));
                    let a = this.wake(e, t, s, i);
                    switch (a || (a = this.createObject(e, t, s, i)),
                    a.type) {
                    case "wall":
                ...
                mergeAll() {
                    ...
                    "air"in Ie.sys.dist ? (e.sort(((e,s)=>t(e, s))),
                    e.push(Ie.sys)) : (e.push(Ie.sys),
                    e.sort(((e,s)=>t(e, s)))),
                ...
                putToSleep() {
                    ...
                    this.npc = this.sleep(this.npc, -64, se.sys.session.h + 64),
                ...
                sleep(e, t=-64, s=1e4) {
                    ...
                    return this.sleeping = this.sleeping.concat(a),
                    e.filter((e=>i(e)))
                }
            }
            Le.sys = null;
            class De {
                ...
                checkCollisions() {
                    const e = Ie.sys
                      ...
                      , a = i.length;
                    function o(e, t) {
                        if (!(e.y < 16) && De.sys.collision(t, e) && !t.objectsHit.includes(e))
                    ...
                    for (let n = 0; n < a; n++) {
                        ...
                        if (!this.collision(e, a) || a.hit || t)
                            "gate" === a.type && !a.hit && a.y < e.y ? (e.failGate(a.gateId),
                            Le.sys.denyGate(a.gateId),
                            a.hit = !0) : "ambient" === a.type && "hidden" === a.anim && a.y + 32 < e.y ? (a.anim = "oneshot",
                            a.time = 0) : "lure" === a.type && a.hit && a.y + 192 < e.y && (Le.sys.buildObject("foe", a.x, a.y + 32, "chase"),
                            a.sleep = !0);
                        else {
                            if (a.hit = !0,
                            e.swapped)
                                return "lure" === a.type && Le.sys.buildObject("foe", a.x, a.y, "chase"),
                                void (a.sleep = !0);
                            switch (a.type) {
                            case "wall":
                            case "snag":
                    ...
                    for (let t = 0; t < n; t++) {
                        ...
                        this.collision(s, e) && !s.hit && s.timer.crash <= 0 && (se.sys.game.shields.current > 0 ? (s.crash(),
                    ...
                    if (!t)
                        for (let t = 0; t < r; t++) {
                            ...
                            this.collision(i, e) && i.timer.crash <= 0 && (s || e.swapped ? i.crash() : se.sys.game.shields.current > 0 ? (i.crash(),
                            e.useShield()) : e.crash())
                        }
                }
                filterVisible(e) {
            ...
            class _e {
                constructor() {
                    ...
                    new De,
                    new ve,
                    pe.sys.createBackground(),
                    this.updateTheme(se.sys.session.settings.theme, !1),
                    this.reflowCanvas(),
                    this.changeGameState(ee.Menu)
                }
                gameLoop(e) {
                    if (Ee.sys.update(),
                    se.sys.session.state !== ee.Pause)
                        switch (se.sys.update(e),
                        se.sys.session.state) {
                        case ee.Play:
                            this.updatePlay();
                            break;
                        case ee.Menu:
                ...
                triggerMenu() {
                    ve.sys.hideNotification(),
                    ve.sys.hideSharePopup(),
                    se.sys.saveGameStats(),
                    se.sys.resetGameData(),
                    pe.sys.defineCanvas(),
                    pe.sys.clearCanvas(),
                    Le.sys.reset(),
                    ve.sys.showMenuScreen(),
                    Ee.sys.reset()
                }
                triggerPlay(e) {
                    e === ee.Menu && this.triggerStart(),
                    ve.sys.hideOverlayUI(),
                    ve.sys.refreshDisplay()
                }
                triggerStart() {
                    se.sys.game.time.elapsed = 0,
                    Ie.sys.unlockForNewGame(),
                    Le.sys.buildStartScene(),
                    ve.sys.hideNotification()
                }
                triggerPause() {
                ...
                triggerOver() {
                    ...
                    ve.sys.showOverScreen(),
                    (se.sys.session.settings.mode !== G.TimeTrial || se.sys.game.finish) && se.sys.saveGameStats();
                    const e = c.p.getBoolean("isNewShare") ? "share" : se.sys.game.highScore ? "score" : "share";
                ...
                updatePlay() {
                    ...
                    ve.sys.updateScore(),
                    se.sys.updateDistances(Ie.sys.speed.x, Ie.sys.speed.y),
                    pe.sys.updateBackground(0, 0, Ie.sys.speed),
                    this.render()
                }
                updateOver() {
                ...
                updateMode() {
                    ve.sys.updateGameModeUI(),
                    ve.sys.sendNotification("mode")
                }
                updateTheme(e, t=!1) {
                    be.sys.loadNewTheme(e),
                    (async()=>{
                        await be.sys.objectsTemp.decode(),
                        await be.sys.playerTemp.decode(),
                        await be.sys.bgTemp.decode(),
                        be.sys.setNewTheme(e),
                        ve.sys.updateIcons(),
                        ve.sys.updateGameTitleUI(),
                        t && ve.sys.sendNotification("theme")
                    }
                    )()
                }
                reflowCanvas() {
                ...
                render() {
                    if (pe.sys.clearCanvas(),
                    se.sys.session.state === ee.Menu)
                        return void Ie.sys.renderCharacterSelection();
            ...
            class je extends z.Z {
                constructor(...e) {
                    ...
                    this.renderHowToPlayContent = ()=>i.createElement(i.Fragment, null, i.createElement(x.nv, {
                        className: this.props.managedClasses.howToPlayModal_paragraph
                    }, i.createElement("strong", null, c.p.getString("endlessModeTitleInline")), " ", c.p.getString("howToPlayEndless")), i.createElement(x.nv, {
                        className: this.props.managedClasses.howToPlayModal_paragraph
                    }, i.createElement("strong", null, c.p.getString("timetrialModeTitleInline")), " ", c.p.getString("howToPlayTimeTrial")), i.createElement(x.nv, {
                        className: this.props.managedClasses.howToPlayModal_paragraph
                    }, i.createElement("strong", null, c.p.getString("zigzagModeTitleInline")), " ", c.p.getString("howToPlayZigZag")), this.renderInputSection()),
                    this.onInputIconKeydown = e=>{
                        let t = this.state.selectedInput;
                        if (e.keyCode === Ne.mW.arrowLeft || e.keyCode === Ne.mW.arrowUp)
                            ...
                            if (e.keyCode !== Ne.mW.arrowRight && e.keyCode !== Ne.mW.arrowDown)
                                return;
                            switch (this.state.selectedInput) {
                            case "keyboard":
                                t = "mouse";
                ...
                render() {
                    return i.createElement(ze.S, Be({}, this.unhandledProps(), {
                        onKeyDown: qe,
                ...
                getInputDescription(e) {
                    const t = this.props.managedClasses.howToPlayModal_icon
                      ...
                      , a = this.props.managedClasses.howToPlayModal_listItem;
                    let o, n, r;
                    switch (e) {
                    case "touch":
                    ...
                    })))), c.p.getString(o)), i.createElement("li", {
                        className: a
                    }, i.createElement("div", {
                        "aria-hidden": !0,
                        className: s
                    ...
                    }(t)), c.p.getString(n)), i.createElement("li", {
                        className: a
                    }, i.createElement("div", {
                        "aria-hidden": !0,
                        className: s
                ...
                renderInputIcons() {
                    const e = (Q() ? [[Oe, "touch"]] : [[Re, "keyboard"], [Fe, "mouse"], [Oe, "touch"], [Ae, "controller"]]).map((e=>{
                        const t = e[0]
                          , s = e[1]
                          , a = this.state.selectedInput === s;
                        let o = this.props.managedClasses.howToPlayModal_inputButton;
                        return a && (o += ` ${this.props.managedClasses.howToPlayModal_inputButton__selected}`),
                        i.createElement(C.XC, {
                            role: "radio",
                            key: s,
            ...
            class et extends z.Z {
                constructor(e) {
                    ...
                    this.copyShareLinkToClipboard = ()=>{
                        Y(c.p.getString("shareLinkFlyout")),
                        this.setState({
                            shareLinkCopied: !0
                        })
                    }
                    ...
                    ,
                    this.toggleSettingsMenu = ()=>{
                        this.state.menuOpen || this.props.gameState !== ee.Play || _e.sys.changeGameState(ee.Pause),
                        this.setState({
                    ...
                    this.openHowToPlayModal = ()=>{
                        this.props.setModal(i.createElement(We, {
                            onClick: Xe,
                            label: c.p.getString("howToPlayDialogTitle"),
                            accept: this.closeModal,
                            acceptMessage: c.p.getString("close"),
                            dismiss: this.closeModal,
                            closeButtonToolTip: c.p.getString("close")
                        }))
                    }
                    ,
                    this.startShare = ()=>{
                        ce.startShare(c.p.getString("highScoreShareTitle"), c.p.getString("highScoreShareSubtitle"), c.p.getString("highScoreNotification"), c.p.getString("shareLinkGameOver"))
                    }
                    ,
                    this.openGameCreditsModal = ()=>{
                        this.props.setModal(i.createElement(ze.S, {
                            onClick: Xe,
                            label: c.p.getString("gameCreditsDialogTitle"),
                            accept: this.closeModal,
                            acceptMessage: c.p.getString("close"),
                            dismiss: this.closeModal,
                            closeButtonToolTip: c.p.getString("close"),
                    ...
                    ,
                    this.getGameCreditsModalBody = ()=>i.createElement(i.Fragment, null, i.createElement(x.nv, null, "Parker Young, Scott Porterfield, Patrick Evan Little, Connor Smith, William Devereux, Adina Shanholtz, Ray Rivers, 陈嘉钰, 傅远, 胡雨阳, 郑俊豪"), i.createElement(M.X6, {
                        className: this.props.managedClasses.settingsHamburgerMenu_creditsTable_specialThanks,
                        size: S.Gm._7,
                        tag: S.lb.h3
                    }, c.p.getString("specialThanks")), i.createElement(x.nv, null, "Jonathan Merrin, Charles Duval, Addison Kaufmann, Rachel Weil, Joseph Oak, Amanda Velasco Gallardo, Ramya Challa, Chris Pirih")),
                    this.confirmResetStats = ()=>{
                        this.props.setModal(i.createElement(F.Z, {
                            title: c.p.getString("resetAllStatsDialogTitle"),
                            closeButtonTooltip: c.p.getString("close"),
                            dialogText: c.p.getString("resetAllStatsDialogText"),
                            confirmText: c.p.getString("resetAllStats"),
                            rejectText: c.p.getString("cancel"),
                ...
                render() {
                    return i.createElement(i.Fragment, null, i.createElement(o.h, {
                        designSystem: Je
                    }, i.createElement(V.ZP, {
                        value: Ye,
                        tag: null,
                        drawBackground: !1
                    }, i.createElement(C.XC, $e({}, this.unhandledProps(), {
                        ref: this.buttonRef,
                        onClick: this.onHamburgerMenuClick,
                        className: (0,
                        N.A)(this.props.managedClasses.settingsHamburgerMenu)
                ...
                renderMenu() {
                    ...
                    return i.createElement(k.zg, {
                        className: this.props.managedClasses.settingsHamburgerMenu_flyout,
                        width: "280px",
                        height: "fit-content",
                        defaultVerticalPosition: Z._k.bottom,
                        defaultHorizontalPosition: Z.xN.left,
                        verticalPositioningMode: Z.Lc.adjacent,
                        visible: this.state.menuOpen,
                        anchor: this.buttonRef,
                        onDismiss: this.dismissMenu,
                        onClick: Xe
                    }, this.renderCloseButton(), i.createElement(T.Of, {
                        jssStyleSheet: w,
                        onClick: this.onNewGameClick
                    }, c.p.getString("newGame")), i.createElement(E.iz, {
                        className: this.props.managedClasses.settingsHamburgerMenu_flyout_divider
                    }), this.renderGameModePicker(), i.createElement(x.nv, {
                    ...
                    }))), c.p.getStringF("bestScoreFlyout", e)), i.createElement(E.iz, {
                        className: this.props.managedClasses.settingsHamburgerMenu_flyout_divider
                    }), this.renderShareSection(), this.renderStartShare(), i.createElement(E.iz, {
                        className: this.props.managedClasses.settingsHamburgerMenu_flyout_divider
                    }), this.renderToggleSection(), i.createElement(E.iz, {
                        className: this.props.managedClasses.settingsHamburgerMenu_flyout_divider
                    }), this.renderButtonSection());
                    var t
                }
                renderCloseButton() {
                    return i.createElement(C.XC, {
                        className: this.props.managedClasses.settingsHamburgerMenu_closeButton,
                        title: c.p.getString("close"),
                        onClick: this.dismissMenu
                    }, (0,
                    A.p)(this.props.managedClasses.settingsHamburgerMenu_closeButton_icon))
                }
                renderGameModePicker() {
                    const e = c.p.getString("zigzagTitle")
                      , t = c.p.getString("endlessTitle")
                      , s = c.p.getString("timetrialTitle")
                      , a = this.props.mode
                      , o = this.props.gameState === ee.Pause || this.props.gameState === ee.Play;
                    return i.createElement(i.Fragment, null, i.createElement(P.__, {
                        className: this.props.managedClasses.settingsHamburgerMenu_flyout_label
                    }, o ? c.p.getString("gameModeSelectLabelDisabled") : c.p.getString("gameModeSelectLabel")), i.createElement(I.Ph, {
                        jssStyleSheet: m.O0,
                        menu: m.gj,
                ...
                renderToggleSection() {
                    ...
                    }, i.createElement(P.__, {
                        htmlFor: "highVisibilityMode"
                    }, c.p.getString("highVisiblityModeToggleLabel")), i.createElement(D.ZD, {
                        jssStyleSheet: f,
                    ...
                    }, c.p.getString("reducedSpeedModeToggleLabel")), i.createElement(D.ZD, {
                        jssStyleSheet: f,
                ...
                renderShareSection() {
                    return i.createElement(i.Fragment, null, i.createElement("div", {
                        ...
                        htmlFor: "shareButton"
                    }, c.p.getString("share")), i.createElement(_.ER, {
                        id: "shareButton",
                        jssStyleSheet: H,
                        onClick: this.copyShareLinkToClipboard,
                        beforeContent: this.state.shareLinkCopied ? B : q
                    }, this.state.shareLinkCopied ? c.p.getString("shareLinkCopied") : c.p.getString("shareCopy"))))
                }
                renderStartShare() {
                    return c.p.getBoolean("isDebugMode") && Q() ? i.createElement("div", null, i.createElement(T.Of, {
                        jssStyleSheet: H,
                        onClick: this.startShare
                    }, c.p.getString("startShare"))) : i.createElement(i.Fragment, null)
                }
                renderButtonSection() {
                    return i.createElement("div", {
                        className: this.props.managedClasses.settingsHamburgerMenu_flyout_buttonSection
                    }, i.createElement(T.Of, {
                        jssStyleSheet: H,
                        onClick: this.openHowToPlayModal
                    }, c.p.getString("howToPlayButton")), i.createElement(T.Of, {
                        jssStyleSheet: H,
                        onClick: this.openGameCreditsModal
                    }, c.p.getString("gameCreditsButton")), i.createElement(T.Of, {
                        jssStyleSheet: H,
                        onClick: this.confirmResetStats
                    }, c.p.getString("resetAllStats")))
                }
            }
            const tt = (0,
            n.$j)((function(e) {
            ...
            function st() {
                ...
                return i.createElement(i.Fragment, null, i.createElement(tt, {
                    setModal: t
                }), i.createElement(r.f, {
                    modal: e,
            ...
            if (c.p.valueExists("redirectUrl")) {
                const e = c.p.getString("redirectUrl");
                ...
                async function() {
                    ...
                    function() {
                        ...
                        e.style.zIndex = d._p.CONTEXT_MENU.toString(),
                        a.render(i.createElement(n.zt, {
                            store: he
                        }, i.createElement(o.h, {
                            designSystem: l.fn
                        }, i.createElement(st, null))), e)
                    }()
                }
                ))
        }
        ...
        81164: (e,t,s)=>{
            ...
            var i, a = s(11754), o = s(37834), n = s(89526), r = s(12468);
            !function(e) {
                e.a = "a",
                e.button = "button"
            }(i || (i = {}));
            ...
            l.displayName = `${r.DisplayNamePrefix}Button`,
            l.defaultProps = {
                managedClasses: {}
            };
            const h = l
        ...
        81545: (e,t,s)=>{
            ...
            class b extends i.Z {
                constructor() {
                    ...
                    this.focusOnFirstElement = ()=>{
                        if ((0,
                        r.N)() && this.rootElement.current instanceof HTMLElement) {
                            const e = (0,
                            d.ht)(this.rootElement.current);
                    ...
                    this.invokeFocusOnCloseTarget = ()=>{
                        if ((0,
                        l.Z)(this.props.focusTargetOnClose))
                            return;
                        if ((0,
                        h.Z)(this.props.focusTargetOnClose))
                            return void this.props.focusTargetOnClose();
                        const e = (0,
                        a.x)(this.props.focusTargetOnClose);
                ...
                componentDidMount() {
                    (0,
                    r.N)() && (this.shouldAddKeyListener(this.props) && document.addEventListener("keydown", this.handleDocumentKeyDown),
                ...
                componentDidUpdate(e) {
                    (0,
                    r.N)() && (!e.modal && this.props.modal ? (document.addEventListener("focusin", this.handleDocumentFocus),
                ...
                componentWillUnmount() {
                    (0,
                    r.N)() && (this.shouldAddKeyListener(this.props) && document.removeEventListener("keydown", this.handleDocumentKeyDown),
                    this.props.modal && document.removeEventListener("focusin", this.handleDocumentFocus),
                    this.invokeFocusOnCloseTarget())
                }
                generateClassNames() {
                    return super.generateClassNames((0,
                    n.A)(this.props.managedClasses.dialog))
                }
                renderModalOverlay() {
                    if (this.props.modal)
                        return c.createElement("div", {
                            className: (0,
                            n.A)(this.props.managedClasses.dialog_modalOverlay),
            ...
            b.displayName = `${p.DisplayNamePrefix}Dialog`;
            const g = b
        }
        ,
        46076: (e,t,s)=>{
        ...
        46371: (e,t,s)=>{
            ...
            class l extends i.Z {
                ...
                generateAttributes() {
                    if (this.props.role && this.props.role !== r.Q.separator)
                        return {
                ...
                generateClassNames() {
                    return super.generateClassNames((0,
                    a.A)(this.props.managedClasses.divider))
                }
            }
            l.displayName = `${n.DisplayNamePrefix}Divider`,
            l.defaultProps = {
                managedClasses: {}
            };
            const h = l
        ...
        2364: (e,t,s)=>{
            ...
            class h extends i.Z {
                ...
                get tag() {
                    return (0,
                    o.Z)(l.q[this.props.tag]) ? l.q.label : l.q[this.props.tag]
                }
                render() {
                    return n.createElement(this.tag, Object.assign({}, this.unhandledProps(), {
                        className: this.generateClassNames()
                ...
                generateClassNames() {
                    ...
                    return super.generateClassNames((0,
                    a.A)(e, [t, this.props.hidden]))
                }
            }
            h.displayName = `${r.DisplayNamePrefix}Label`,
            h.defaultProps = {
                tag: l.q.label,
                managedClasses: {}
            };
        ...
        28293: (e,t,s)=>{
            ...
            class h extends i.Z {
                ...
                generateClassNames() {
                    ...
                    return super.generateClassNames((0,
                    o.A)(e, [t, this.props.disabled], [s, this.isItemSelected()]))
                }
                invokeOption(e) {
            ...
            h.displayName = `${l.DisplayNamePrefix}ListboxItem`,
            h.contextType = r.R,
            h.defaultProps = {
                disabled: !1,
                managedClasses: {}
        ...
        42999: (e,t,s)=>{
            ...
            class g extends i.Z {
                constructor(e) {
                    ...
                    this.renderChild = (e,t)=>d.cloneElement(e, {
                    ...
                    this.getInitialSelection = ()=>{
                        let e;
                        return e = void 0 !== this.props.selectedItems ? g.getListboxItemDataFromIds(this.props.selectedItems, this.props.children) : g.getListboxItemDataFromIds(this.props.defaultSelection, this.props.children),
                    ...
                    this.processTypeAhead = e=>{
                        ...
                        let t = -1;
                        d.Children.toArray(this.props.children).some(((e,s)=>void 0 !== e.props[this.props.typeAheadPropertyKey] && ((0,
                        o.Ny)(e.props[this.props.typeAheadPropertyKey].toLowerCase(), this.typeAheadString) ? (t = s,
                        !0) : void 0))),
                        -1 !== t ? (this.typeAheadTimer = setTimeout((()=>{
                    ...
                    this.updateSelection = e=>{
                        ...
                        return (0,
                        l.Z)(t, this.state.selectedItems) || (void 0 === this.props.selectedItems && this.setState({
                            selectedItems: t
                        }),
                ...
                componentDidUpdate(e) {
                    let t = null;
                    if ((0,
                    l.Z)(e.defaultSelection, this.props.defaultSelection) || void 0 !== this.props.selectedItems || (t = this.updateSelection(this.getInitialSelection())),
                    e.children !== this.props.children) {
                        t = null === t ? this.updateSelection(this.state.selectedItems.slice(0)) : t;
                        const e = this.domChildren();
                        if (!(0,
                        h.Z)(this.rootElement.current) && this.rootElement.current.contains(document.activeElement))
                ...
                domChildren() {
                    return (0,
                    r.N)() && this.rootElement.current instanceof HTMLElement ? Array.from(this.rootElement.current.children) : []
                }
                setFocus(e, t) {
            ...
            g.displayName = `${p.DisplayNamePrefix}Listbox`,
            g.defaultProps = {
                multiselectable: !1,
                defaultSelection: [],
        ...
        63566: (e,t,s)=>{
            ...
            class m extends i.Z {
                constructor(e) {
                    ...
                    this.updateSelection = e=>{
                        ...
                        h.Z)(e, this.state.selectedItems) || this.props.onValueChange(t, e, s),
                    ...
                    this.updateSelectionFromProps = ()=>{
                        const e = this.trimSelection(b.default.getListboxItemDataFromIds(this.props.selectedItems, this.props.children));
                        this.setState({
                            selectedItems: e,
                    ...
                    this.getSelectedItemPosInSet = (e,t)=>{
                        if (!this.props.multiselectable && 1 === t.length) {
                            const s = t[0].id
                              , i = e.length;
                            for (let t = 0; t < i; t++)
                                if (e[t].props[m.idPropertyKey] === s)
                                    return t + 1
                        }
                        return 0
                    }
                    ...
                    this.defaultTriggerRenderFunction = (e,t,s)=>{
                        if (e.multiselectable)
                            return null;
                        const i = `${(0,
                        c.Z)(this.props.labelledBy) ? "" : `${this.props.labelledBy} `}${s}`
                          , a = "" + ((0,
                        c.Z)(this.props.describedBy) ? "" : `${this.props.describedBy}`);
                    ...
                    this.incrementSelectedOption = e=>{
                        ...
                        if (1 === this.state.selectedItems.length) {
                            const s = b.default.getItemIndexById(this.state.selectedItems[0].id, this.props.children);
                            if (-1 !== s) {
                                const i = s + e
                                  , a = e > -1 ? t.length - 1 : 0;
                    ...
                    this.selectItemInRange = (e,t,s,i)=>{
                        const a = b.default.getFirstValidOptionInRange(e, t, s, i);
                        (0,
                        c.Z)(a) || this.updateSelection([a.props])
                    }
                    ,
                    this.toggleMenu = e=>{
                    ...
                    this.handleMenuBlur = e=>{
                        ...
                        o.Re)(e.relatedTarget) && e.relatedTarget.id === this.triggerId) && this.toggleMenu(!1)
                    }
                    ,
                    ...
                    ,
                    this.getValidOptions = ()=>b.default.getValidOptions(p.Children.toArray(this.props.children));
                    let t = this.trimSelection(b.default.getListboxItemDataFromIds(void 0 !== this.props.selectedItems ? this.props.selectedItems : this.props.defaultSelection, this.props.children));
                ...
                generateClassNames() {
                    const {select: e, select__scaleToFit: t, select__disabled: s, select_menu__open: i, select__multiSelectable: a} = this.props.managedClasses;
                    return super.generateClassNames((0,
                    n.A)(e, [t, !(0,
                    c.Z)(this.props.menuFlyoutConfig) && this.props.menuFlyoutConfig.scaleToFit], [s, this.props.disabled], [i, this.state.isMenuOpen], [a, this.props.multiselectable]))
                }
                ...
                renderMenu() {
                    ...
                    const t = p.createElement(b.default, {
                        ...
                        managedClasses: {
                            listbox: (0,
                            d.Z)(this.props.managedClasses, "select_menu", ""),
                            listbox__disabled: (0,
                            d.Z)(this.props.managedClasses, "select_menuDisabled", "")
                        }
                    }, this.props.children)
                      , s = "function" == typeof this.props.menu ? this.props.menu(this.props, this.state, t) : t;
                    return (0,
                    c.Z)(this.props.menuFlyoutConfig) ? s : p.createElement(u.ZP, Object.assign({
                ...
                generateViewportPositionerClassNames() {
                    const {select__menuPositioningRegion: e, select__menuPositionLeft: t, select__menuPositionRight: s, select__menuPositionTop: i, select__menuPositionBottom: a, select__menuPositionHorizontalInset: o, select__menuPositionVerticalInset: n} = this.props.managedClasses;
                    return {
            ...
            m.displayName = `${g.DisplayNamePrefix}Select`,
            m.defaultProps = {
                multiselectable: !1,
                disabled: !1,
                defaultSelection: [],
        ...
        39093: (e,t,s)=>{
            ...
            class r extends i.Z {
                ...
                generateClassNames() {
                    ...
                    return super.generateClassNames((0,
                    a.A)(e, [t, this.props.disabled], [s, this.state.selected]))
                }
                ...
                generateLabel() {
                    if (this.props.labelId || this.props.children)
                        return o.createElement("label", {
                            className: (0,
                            a.A)(this.props.managedClasses.toggle_label),
                ...
                renderStatusMessage() {
                    if (this.props.selectedMessage || this.props.unselectedMessage)
                        return o.createElement("span", {
                            ...
                            className: (0,
                            a.A)(this.props.managedClasses.toggle_statusMessage)
                        }, this.generateToggleStateLabel())
                }
            }
            r.displayName = `${n.DisplayNamePrefix}Toggle`,
            r.defaultProps = {
                managedClasses: {}
            };
            const l = r
        ...
        45207: (e,t,s)=>{
            ...
            class l extends i.Z {
                ...
                generateClassNames() {
                    ...
                    return super.generateClassNames((0,
                    a.A)(e.typography, e[`typography__${this.props.size}`]))
                }
                generateHTMLTag() {
            ...
            l.displayName = `${n.DisplayNamePrefix}Typography`;
            const h = l
        }
        ,
        14895: (e,t,s)=>{
            ...
            class u extends i.Z {
                constructor(e) {
                    ...
                    this.updateDisabledState = ()=>{
                        (0,
                        n.N)() && !0 !== this.props.disabled ? (null === this.getAnchorElement() || null === this.getViewportElement(this.props.viewport)) && this.state.validRefChecksRemaining > 0 ? this.setState({
                    ...
                    this.enableComponent = ()=>{
                        ...
                        l.Z)(t) || (0,
                        l.Z)(e) || (0,
                        l.Z)(this.rootElement.current) || (window.IntersectionObserver && window.ResizeObserver && !this.props.shouldUseNoObserverMode ? (this.setState({
                            disabled: !1,
                            noObserverMode: !1,
                    ...
                    this.detachListeners = e=>{
                        ...
                        (0,
                        l.Z)(t) || t.removeEventListener("scroll", this.handleScroll),
                    ...
                    this.handleAnchorResize = e=>{
                        ...
                        this.state.currentVerticalPosition === g.top || this.state.currentVerticalPosition === g.insetTop ? this.anchorBottom = this.anchorTop + this.anchorHeight : this.anchorTop = this.anchorBottom - this.anchorHeight,
                        this.state.currentHorizontalPosition === b.left || this.state.currentHorizontalPosition === b.insetLeft ? this.anchorRight = this.anchorLeft + this.anchorWidth : this.anchorLeft = this.anchorRight - this.anchorWidth,
                        this.requestFrame()
                    }
                    ,
                    this.handleCollision = (e,t)=>{
                        ...
                        (0,
                        l.Z)(i) || (this.scrollTop = i.scrollTop,
                    ...
                    this.updateLayout = ()=>{
                        ...
                        l.Z)(this.viewportRect) || (0,
                        l.Z)(this.positionerDimension) || this.props.fixedAfterInitialPlacement && this.state.initialLayoutComplete || this.state.noObserverMode && this.state.initialLayoutComplete)
                            return;
                        this.updateForScrolling();
                        let e = g.undefined
                          , t = b.undefined;
                    ...
                    this.getNextPositionerDimension = (e,t)=>{
                        ...
                        l.Z)(this.props.verticalThreshold) ? 0 : this.props.verticalThreshold),
                        s.width = Math.max(Math.min(this.getAvailableWidth(e), this.viewportRect.width), (0,
                        l.Z)(this.props.horizontalThreshold) ? 0 : this.props.horizontalThreshold)),
                        s
                    }
                    ,
                    ...
                    l.Z)(this.props.anchor) ? null : this.extractElement(this.props.anchor),
                ...
                generateClassNames() {
                    ...
                    return super.generateClassNames((0,
                    a.A)(e, [t, l === b.left || l === b.insetLeft], [s, l === b.right || l === b.insetRight], [n, d], [i, h === g.top || h === g.insetTop], [o, h === g.bottom || h === g.insetBottom], [r, c]))
                }
            }
            u.displayName = `${c.DisplayNamePrefix}ViewportPositioner`,
            u.contextType = p,
            u.defaultProps = {
    ...
    i.O = (t,s,a,o)=>{
        if (!s) {
            ...
            for (c = 0; c < e.length; c++) {
                for (var [s,a,o] = e[c], r = !0, l = 0; l < s.length; l++)
                    (!1 & o || n >= o) && Object.keys(i.O).every((e=>i.O[e](s[l]))) ? s.splice(l--, 1) : (r = !1,
                    o < n && (n = o));
                if (r) {
                    e.splice(c--, 1);
                    var h = a();
