...
(function(w) {
    ...
    function shareText(cps) {
        ...
        if (cps <= 5) return '来了，来看就知道了~';
        if (cps <= 8) return '我看你是完全不懂喔~';
        if (cps <= 10)  return '真的太逊了！';
        if (cps <= 15) return '哟，你脸红了？！';
        return '不要！！！';
    }
    ...
    function initSetting() {
        ...
        $("title").text(cookie("title") ? cookie("title") : "点燃TNT");
